        ...
        ScheduleMatchRequest: {
          ...
          properties: {
            ...
            scheduledDate: {
              ...
              format: 'date-time',
              description:
                'Scheduled date and time for the match (must be in the future)',
              example: '2024-12-25T15:00:00.000Z',
            },
            venue: {
              type: 'string',
    ...
    paths: {
      ...
      '/matches': {
        get: {
          ...
          description:
            'Retrieve all matches with optional filtering via query parameters',
          parameters: [
            {
              name: 'upcoming',
              in: 'query',
      ...
      '/matches/{id}': {
        ...
        delete: {
          ...
          description:
            'Cancel a previously scheduled match using its unique identifier',
          parameters: [
            {
              name: 'id',
              in: 'path',
